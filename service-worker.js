const CACHE_NAME = 'cache-v7'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v7',
    'estilos/styles.css?v7',
    'estilos/mediaQueries.css?v7',
    'javascript/script.js?v7',
